...
newService = {"service":{"name":"IdP Google service", "description": "IdP Google service", "type":"idp.oauth"}} #idpNormal
...
idpAdminURL    = "https://www.googleapis.com/oauth2/v3/"
...
newEndpoint["endpoint"]["id_service"]=idpIdService
